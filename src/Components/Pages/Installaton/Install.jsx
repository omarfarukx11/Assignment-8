...
const Install = ({ installApp, handleUninstall }) => {
  ...
  return (
    <div className=" mt-5 ">
      <div className="flex px-5 flex-col sm:flex-row md:gap-5 gap-10 justify-between items-center py-4 shadow-xl rounded-xl bg-[#ffffff]">
        <div className="flex items-center gap-10 sm:gap-5 sm:flex-row flex-col text-center sm:text-start ">
          ...
          <div>
            ...
            <div>
              <div className="flex items-center gap-5">
                ...
                <p className="md:text-xl text-sm font-semibold text-gray-600">{size} MB</p>
              </div>
            </div>
          </div>
        </div>
