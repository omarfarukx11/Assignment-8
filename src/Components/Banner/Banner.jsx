      ...
      <div className="flex items-center justify-center flex-col">
        ...
        <div className="card-actions justify-center pt-10">
          <div className="btn  flex items-center justify-center gap-3 py-5">
            <a href="https://play.google.com/store/apps?hl=en" target="main">
              <span className="flex items-center gap-3">
                <img className="w-[25px] " src={PlayStoreImg} alt="" /> Google
                Play{" "}
              </span>
            </a>
          </div>
          <div className="btn  flex items-center justify-center gap-3 py-5">
            <a href="https://www.apple.com/app-store" target="main">
              <span className="flex items-center gap-3">
                <img className="w-[25px] " src={AppStoreImg} alt="" />
                App Store
              </span>
            </a>
          </div>
