    ...
    <footer className="sm:footer-horizontal bg-neutral text-neutral-content p-10">
      <div className="flex justify-between pb-5  gap-5">
        <div className="flex items-center gap-2 justify-center">
          <img className="md:w-[70px] w-[30px]" src={Logo} alt="" />
          <h1 className="md:text-2xl text-xl font-semibold">HERO.IO</h1>
        </div>
        <nav>
      ...
      <div className="text-center text-lg md:text-2xl pt-10 border-t-1 border-gray-600">
